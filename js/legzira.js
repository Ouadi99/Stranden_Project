let YO_legzira = L.map('YO_legzira').setView([29.42965792531859, -10.138887420818724], 4);
...
let marker_legzira = L.marker([29.42965792531859, -10.138887420818724], {icon: myIcon}).addTo(YO_legzira);
